...
func (e *TSExecutor) executeStep(step TestStep) (*StepResult, error) {
	...
	const hardcodedJWT = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI4YmQxNjFhYS1iYjEyLTExZjAtOTgyYS1jNjc4ZGU1NzY2ZWYiLCJ1c2VybmFtZSI6ImFkbWluIiwiaWF0IjoxNzYyNzc5NTU5LCJleHAiOjE3NjUzNzE1NTl9.6eYubLPlOcbpGyoM89848DKxom_AvvruU2tskv7l3Aw"
	req.Header.Set("Authorization", fmt.Sprintf("Bearer %s", hardcodedJWT))
